...
/**
 * DiagonalPattern creates subtle diagonal line patterns.
 * Geometric line overlays for visual texture.
 */
...
/**
 * Standalone function to get diagonal pattern CSS for inline use
 */
export function getDiagonalPatternCSS(
